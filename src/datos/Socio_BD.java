...
public class Socio_BD {
	...
	public void altaSocio(String nombre, String apellido, String dni, String direccion, String telefono, String email, String legajo, String usuario, String contraseña) throws SQLException {
		Conexion_BD con = new Conexion_BD();
		connection = con.openConnection();

		PreparedStatement statement = connection.prepareStatement("INSERT INTO socio (idSocio, nombre, apellido, dni, direccion, email, legajo, telefono, fechaAlta, usuario, clave) VALUES (null, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
